...
/// @nodoc
@JsonSerializable()
class _$GdkConfigImpl extends _GdkConfig with DiagnosticableTreeMixin {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'GdkConfig'))
      ..add(DiagnosticsProperty('dataDir', dataDir))
      ..add(DiagnosticsProperty('torDir', torDir))
      ..add(DiagnosticsProperty('registryDir', registryDir))
...
mixin _$GdkConnectionParams {
  ...
  @JsonKey(name: 'min_fee_rate')
  int? get minFeeRate => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      certExpiryThreshold: freezed == certExpiryThreshold
          ...
          : certExpiryThreshold // ignore: cast_nullable_to_non_nullable
              as int?,
      minFeeRate: freezed == minFeeRate
          ? _value.minFeeRate
          : minFeeRate // ignore: cast_nullable_to_non_nullable
              as int?,
    ) as $Val);
  }
}
...
class _$GdkConnectionParamsImpl extends _GdkConnectionParams
  ...
  const _$GdkConnectionParamsImpl(
      ...
      @JsonKey(name: 'min_fee_rate') this.minFeeRate})
      : super._();
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'GdkConnectionParams(name: $name, proxy: $proxy, useTor: $useTor, userAgent: $userAgent, spvEnabled: $spvEnabled, certExpiryThreshold: $certExpiryThreshold, minFeeRate: $minFeeRate)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkConnectionParams'))
      ..add(DiagnosticsProperty('name', name))
      ..add(DiagnosticsProperty('proxy', proxy))
      ..add(DiagnosticsProperty('useTor', useTor))
      ..add(DiagnosticsProperty('userAgent', userAgent))
      ..add(DiagnosticsProperty('spvEnabled', spvEnabled))
      ..add(DiagnosticsProperty('certExpiryThreshold', certExpiryThreshold))
      ..add(DiagnosticsProperty('minFeeRate', minFeeRate));
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.minFeeRate, minFeeRate) ||
                other.minFeeRate == minFeeRate));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, name, proxy, useTor, userAgent,
      spvEnabled, certExpiryThreshold, minFeeRate);
...
abstract class _GdkConnectionParams extends GdkConnectionParams {
  const factory _GdkConnectionParams(
      ...
      @JsonKey(name: 'cert_expiry_threshold') final int? certExpiryThreshold,
      @JsonKey(name: 'min_fee_rate')
      final int? minFeeRate}) = _$GdkConnectionParamsImpl;
...
/// @nodoc
@JsonSerializable()
class _$GdkPinDataImpl with DiagnosticableTreeMixin implements _GdkPinData {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkPinData'))
      ..add(DiagnosticsProperty('encryptedData', encryptedData))
      ..add(DiagnosticsProperty('pinIdentifier', pinIdentifier))
...
class _$GdkLoginCredentialsImpl extends _GdkLoginCredentials
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkLoginCredentials'))
      ..add(DiagnosticsProperty('mnemonic', mnemonic))
      ..add(DiagnosticsProperty('username', username))
      ..add(DiagnosticsProperty('password', password))
      ..add(DiagnosticsProperty('bip39Passphrase', bip39Passphrase))
      ..add(DiagnosticsProperty('pin', pin))
      ..add(DiagnosticsProperty('pinData', pinData));
  }
...
/// @nodoc
@JsonSerializable()
class _$GdkDeviceImpl extends _GdkDevice with DiagnosticableTreeMixin {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkDevice'))
      ..add(DiagnosticsProperty('name', name))
      ..add(DiagnosticsProperty('supportsAeProtocol', supportsAeProtocol))
      ..add(DiagnosticsProperty(
          'supportsArbitraryScripts', supportsArbitraryScripts))
      ..add(
          DiagnosticsProperty('supportsHostUnblinding', supportsHostUnblinding))
      ..add(DiagnosticsProperty('supportsLiquid', supportsLiquid))
      ..add(DiagnosticsProperty('supportsLowR', supportsLowR));
  }
...
/// @nodoc
@JsonSerializable()
class _$GdkHwDeviceImpl extends _GdkHwDevice with DiagnosticableTreeMixin {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkHwDevice'))
...
GdkGetSubaccountsDetails _$GdkGetSubaccountsDetailsFromJson(
    Map<String, dynamic> json) {
  return _GdkGetSubaccountsDetails.fromJson(json);
}

/// @nodoc
mixin _$GdkGetSubaccountsDetails {
  @JsonKey(name: 'refresh')
  bool? get refresh => throw _privateConstructorUsedError;

  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $GdkGetSubaccountsDetailsCopyWith<GdkGetSubaccountsDetails> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GdkGetSubaccountsDetailsCopyWith<$Res> {
  factory $GdkGetSubaccountsDetailsCopyWith(GdkGetSubaccountsDetails value,
          $Res Function(GdkGetSubaccountsDetails) then) =
      _$GdkGetSubaccountsDetailsCopyWithImpl<$Res, GdkGetSubaccountsDetails>;
  @useResult
  $Res call({@JsonKey(name: 'refresh') bool? refresh});
}

/// @nodoc
class _$GdkGetSubaccountsDetailsCopyWithImpl<$Res,
        $Val extends GdkGetSubaccountsDetails>
    implements $GdkGetSubaccountsDetailsCopyWith<$Res> {
  _$GdkGetSubaccountsDetailsCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$GdkGetSubaccountsDetailsImplCopyWith<$Res>
    implements $GdkGetSubaccountsDetailsCopyWith<$Res> {
  factory _$$GdkGetSubaccountsDetailsImplCopyWith(
          _$GdkGetSubaccountsDetailsImpl value,
          $Res Function(_$GdkGetSubaccountsDetailsImpl) then) =
      __$$GdkGetSubaccountsDetailsImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: 'refresh') bool? refresh});
}
...
/// @nodoc
class __$$GdkGetSubaccountsDetailsImplCopyWithImpl<$Res>
    extends _$GdkGetSubaccountsDetailsCopyWithImpl<$Res,
        _$GdkGetSubaccountsDetailsImpl>
    implements _$$GdkGetSubaccountsDetailsImplCopyWith<$Res> {
  __$$GdkGetSubaccountsDetailsImplCopyWithImpl(
      _$GdkGetSubaccountsDetailsImpl _value,
      $Res Function(_$GdkGetSubaccountsDetailsImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GdkGetSubaccountsDetailsImpl(
      refresh: freezed == refresh
          ? _value.refresh
          : refresh // ignore: cast_nullable_to_non_nullable
              as bool?,
...
/// @nodoc
@JsonSerializable()
class _$GdkGetSubaccountsDetailsImpl extends _GdkGetSubaccountsDetails
    with DiagnosticableTreeMixin {
  const _$GdkGetSubaccountsDetailsImpl({@JsonKey(name: 'refresh') this.refresh})
      : super._();

  factory _$GdkGetSubaccountsDetailsImpl.fromJson(Map<String, dynamic> json) =>
      _$$GdkGetSubaccountsDetailsImplFromJson(json);
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'GdkGetSubaccountsDetails(refresh: $refresh)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkGetSubaccountsDetails'))
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GdkGetSubaccountsDetailsImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GdkGetSubaccountsDetailsImplCopyWith<_$GdkGetSubaccountsDetailsImpl>
      get copyWith => __$$GdkGetSubaccountsDetailsImplCopyWithImpl<
          _$GdkGetSubaccountsDetailsImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GdkGetSubaccountsDetailsImplToJson(
      this,
    );
  }
}

abstract class _GdkGetSubaccountsDetails extends GdkGetSubaccountsDetails {
  const factory _GdkGetSubaccountsDetails(
          {@JsonKey(name: 'refresh') final bool? refresh}) =
      _$GdkGetSubaccountsDetailsImpl;
  const _GdkGetSubaccountsDetails._() : super._();

  factory _GdkGetSubaccountsDetails.fromJson(Map<String, dynamic> json) =
      _$GdkGetSubaccountsDetailsImpl.fromJson;
...
mixin _$GdkSubaccount {
  ...
  @JsonKey(name: 'core_descriptors')
  List<String>? get coreDescriptors => throw _privateConstructorUsedError;
  ...
  @JsonKey(name: 'slip132_extended_pubkey')
  String? get slip132ExtendedPubkey => throw _privateConstructorUsedError;
...
class _$GdkSubaccountCopyWithImpl<$Res, $Val extends GdkSubaccount>
  ...
  @override
  $Res call({
    Object? bip44Discovered = null,
    Object? coreDescriptors = freezed,
    Object? hidden = null,
    Object? name = freezed,
    Object? pointer = freezed,
    Object? receivingId = freezed,
    Object? requiredCa = freezed,
    Object? slip132ExtendedPubkey = freezed,
    Object? type = freezed,
    Object? userPath = freezed,
  }) {
    return _then(_value.copyWith(
      bip44Discovered: null == bip44Discovered
          ? _value.bip44Discovered
          : bip44Discovered // ignore: cast_nullable_to_non_nullable
              as bool,
      coreDescriptors: freezed == coreDescriptors
          ? _value.coreDescriptors
          : coreDescriptors // ignore: cast_nullable_to_non_nullable
              as List<String>?,
      hidden: null == hidden
          ? _value.hidden
      ...
      requiredCa: freezed == requiredCa
          ...
          : requiredCa // ignore: cast_nullable_to_non_nullable
              as int?,
      slip132ExtendedPubkey: freezed == slip132ExtendedPubkey
          ? _value.slip132ExtendedPubkey
          : slip132ExtendedPubkey // ignore: cast_nullable_to_non_nullable
              as String?,
      type: freezed == type
          ? _value.type
...
/// @nodoc
@JsonSerializable()
class _$GdkSubaccountImpl extends _GdkSubaccount with DiagnosticableTreeMixin {
  const _$GdkSubaccountImpl(
      {@JsonKey(name: 'bip44_discovered') this.bip44Discovered = false,
      @JsonKey(name: 'core_descriptors') final List<String>? coreDescriptors,
      this.hidden = false,
      this.name,
      this.pointer,
      @JsonKey(name: 'receiving_id') this.receivingId,
      @JsonKey(name: 'required_ca') this.requiredCa,
      @JsonKey(name: 'slip132_extended_pubkey') this.slip132ExtendedPubkey,
      this.type,
      @JsonKey(name: 'user_path') final List<int>? userPath})
      : _coreDescriptors = coreDescriptors,
        _userPath = userPath,
        super._();
  ...
  final List<String>? _coreDescriptors;
  @override
  @JsonKey(name: 'core_descriptors')
  List<String>? get coreDescriptors {
    final value = _coreDescriptors;
    if (value == null) return null;
    if (_coreDescriptors is EqualUnmodifiableListView) return _coreDescriptors;
  ...
  @override
  @JsonKey(name: 'slip132_extended_pubkey')
  final String? slip132ExtendedPubkey;
  @override
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'GdkSubaccount(bip44Discovered: $bip44Discovered, coreDescriptors: $coreDescriptors, hidden: $hidden, name: $name, pointer: $pointer, receivingId: $receivingId, requiredCa: $requiredCa, slip132ExtendedPubkey: $slip132ExtendedPubkey, type: $type, userPath: $userPath)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkSubaccount'))
      ..add(DiagnosticsProperty('bip44Discovered', bip44Discovered))
      ..add(DiagnosticsProperty('coreDescriptors', coreDescriptors))
      ..add(DiagnosticsProperty('hidden', hidden))
      ..add(DiagnosticsProperty('name', name))
      ..add(DiagnosticsProperty('pointer', pointer))
      ..add(DiagnosticsProperty('receivingId', receivingId))
      ..add(DiagnosticsProperty('requiredCa', requiredCa))
      ..add(DiagnosticsProperty('slip132ExtendedPubkey', slip132ExtendedPubkey))
      ..add(DiagnosticsProperty('type', type))
      ..add(DiagnosticsProperty('userPath', userPath));
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._coreDescriptors, _coreDescriptors) &&
            ...
            (identical(other.slip132ExtendedPubkey, slip132ExtendedPubkey) ||
                other.slip132ExtendedPubkey == slip132ExtendedPubkey) &&
  ...
  int get hashCode => Object.hash(
      runtimeType,
      bip44Discovered,
      const DeepCollectionEquality().hash(_coreDescriptors),
      hidden,
      name,
      pointer,
      receivingId,
      requiredCa,
      slip132ExtendedPubkey,
      type,
...
abstract class _GdkSubaccount extends GdkSubaccount {
  const factory _GdkSubaccount(
      ...
      final GdkSubaccountTypeEnum? type,
      @JsonKey(name: 'user_path')
      final List<int>? userPath}) = _$GdkSubaccountImpl;
  ...
  @override
  @JsonKey(name: 'slip132_extended_pubkey')
  String? get slip132ExtendedPubkey;
  @override
...
/// @nodoc
@JsonSerializable()
class _$GdkLoginUserImpl with DiagnosticableTreeMixin implements _GdkLoginUser {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkLoginUser'))
      ..add(DiagnosticsProperty('walletHashId', walletHashId));
  }
...
/// @nodoc
@JsonSerializable()
class _$GdkGetBalanceImpl extends _GdkGetBalance with DiagnosticableTreeMixin {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkGetBalance'))
      ..add(DiagnosticsProperty('subaccount', subaccount))
      ..add(DiagnosticsProperty('numConfs', numConfs))
      ..add(DiagnosticsProperty('allCoins', allCoins))
      ..add(DiagnosticsProperty('expiredAt', expiredAt))
      ..add(DiagnosticsProperty('confidential', confidential))
      ..add(DiagnosticsProperty('dustLimit', dustLimit));
  }
...
abstract class $GdkAssetsParametersCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool? icons, bool? assets});
}
...
class _$GdkAssetsParametersImpl extends _GdkAssetsParameters
    with DiagnosticableTreeMixin {
  const _$GdkAssetsParametersImpl({this.icons = true, this.assets = true})
      : super._();
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'GdkAssetsParameters(icons: $icons, assets: $assets)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkAssetsParameters'))
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, icons, assets);
...
abstract class _GdkAssetsParameters extends GdkAssetsParameters {
  const factory _GdkAssetsParameters({final bool? icons, final bool? assets}) =
...
mixin _$GdkGetAssetsParameters {
  ...
  List<String>? get assetsId => throw _privateConstructorUsedError;
...
abstract class $GdkGetAssetsParametersCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: 'assets_id') List<String>? assetsId});
}
...
class _$GdkGetAssetsParametersCopyWithImpl<$Res,
  ...
  @override
  $Res call({
    Object? assetsId = freezed,
  }) {
    return _then(_value.copyWith(
      assetsId: freezed == assetsId
          ? _value.assetsId
          : assetsId // ignore: cast_nullable_to_non_nullable
              as List<String>?,
    ) as $Val);
  }
}
...
class _$GdkGetAssetsParametersImpl extends _GdkGetAssetsParameters
    with DiagnosticableTreeMixin {
  const _$GdkGetAssetsParametersImpl(
      {@JsonKey(name: 'assets_id') final List<String>? assetsId})
      : _assetsId = assetsId,
        super._();
  ...
  final List<String>? _assetsId;
  @override
  @JsonKey(name: 'assets_id')
  List<String>? get assetsId {
    final value = _assetsId;
    if (value == null) return null;
    if (_assetsId is EqualUnmodifiableListView) return _assetsId;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(value);
  }
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'GdkGetAssetsParameters(assetsId: $assetsId)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkGetAssetsParameters'))
      ..add(DiagnosticsProperty('assetsId', assetsId));
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other._assetsId, _assetsId));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(_assetsId));
...
abstract class _GdkGetAssetsParameters extends GdkGetAssetsParameters {
  const factory _GdkGetAssetsParameters(
          {@JsonKey(name: 'assets_id') final List<String>? assetsId}) =
      _$GdkGetAssetsParametersImpl;
...
mixin _$GdkAuthHandlerStatusResult {
  ...
  @JsonKey(name: 'subaccounts')
  List<GdkSubaccount>? get subaccounts => throw _privateConstructorUsedError;
  ...
  GdkNewTransactionReply? get createTransaction =>
      throw _privateConstructorUsedError;
  @JsonKey(name: 'change_settings')
  GdkSettingsEvent? get changeSettings => throw _privateConstructorUsedError;
  @JsonKey(name: 'blind_transaction')
  GdkNewTransactionReply? get blindTransaction =>
      throw _privateConstructorUsedError;
  ...
  @JsonKey(name: 'psbt_sign')
  GdkNewTransactionReply? get signPsbt => throw _privateConstructorUsedError;
  @JsonKey(name: 'psbt_get_details')
  GdkNewTransactionReply? get getDetailsPsbt =>
      throw _privateConstructorUsedError;
...
abstract class $GdkAuthHandlerStatusResultCopyWith<$Res> {
  ...
  $GdkSettingsEventCopyWith<$Res>? get changeSettings;
  $GdkNewTransactionReplyCopyWith<$Res>? get blindTransaction;
  $GdkNewTransactionReplyCopyWith<$Res>? get signTx;
  $GdkNewTransactionReplyCopyWith<$Res>? get sendRawTx;
  $GdkNewTransactionReplyCopyWith<$Res>? get signPsbt;
  $GdkNewTransactionReplyCopyWith<$Res>? get getDetailsPsbt;
...
class _$GdkAuthHandlerStatusResultCopyWithImpl<$Res,
  ...
  $Res call({
    ...
    Object? changeSettings = freezed,
    Object? blindTransaction = freezed,
    Object? signTx = freezed,
    Object? sendRawTx = freezed,
    Object? signPsbt = freezed,
    Object? getDetailsPsbt = freezed,
    ...
    return _then(_value.copyWith(
      ...
      changeSettings: freezed == changeSettings
          ? _value.changeSettings
          : changeSettings // ignore: cast_nullable_to_non_nullable
              as GdkSettingsEvent?,
      blindTransaction: freezed == blindTransaction
          ? _value.blindTransaction
          : blindTransaction // ignore: cast_nullable_to_non_nullable
              as GdkNewTransactionReply?,
      ...
      signPsbt: freezed == signPsbt
          ...
          : signPsbt // ignore: cast_nullable_to_non_nullable
              as GdkNewTransactionReply?,
      getDetailsPsbt: freezed == getDetailsPsbt
          ? _value.getDetailsPsbt
          : getDetailsPsbt // ignore: cast_nullable_to_non_nullable
              as GdkNewTransactionReply?,
  ...
  @pragma('vm:prefer-inline')
  $GdkSettingsEventCopyWith<$Res>? get changeSettings {
    if (_value.changeSettings == null) {
      return null;
    }

    return $GdkSettingsEventCopyWith<$Res>(_value.changeSettings!, (value) {
      return _then(_value.copyWith(changeSettings: value) as $Val);
    });
  }
  ...
  @pragma('vm:prefer-inline')
  $GdkNewTransactionReplyCopyWith<$Res>? get blindTransaction {
    if (_value.blindTransaction == null) {
      return null;
    }

    return $GdkNewTransactionReplyCopyWith<$Res>(_value.blindTransaction!,
        (value) {
      return _then(_value.copyWith(blindTransaction: value) as $Val);
    });
  }
  ...
  $GdkNewTransactionReplyCopyWith<$Res>? get signPsbt {
    ...
    return $GdkNewTransactionReplyCopyWith<$Res>(_value.signPsbt!, (value) {
  ...
  @pragma('vm:prefer-inline')
  $GdkNewTransactionReplyCopyWith<$Res>? get getDetailsPsbt {
    if (_value.getDetailsPsbt == null) {
      return null;
    }

    return $GdkNewTransactionReplyCopyWith<$Res>(_value.getDetailsPsbt!,
        (value) {
      return _then(_value.copyWith(getDetailsPsbt: value) as $Val);
    });
  }
...
/// @nodoc
@JsonSerializable()
class _$GdkAuthHandlerStatusResultImpl
    with DiagnosticableTreeMixin
    implements _GdkAuthHandlerStatusResult {
  const _$GdkAuthHandlerStatusResultImpl(
      ...
      @JsonKey(name: 'subaccounts') final List<GdkSubaccount>? subaccounts,
      ...
      @JsonKey(name: 'change_settings') this.changeSettings,
      @JsonKey(name: 'blind_transaction') this.blindTransaction,
      @JsonKey(name: 'sign_tx') this.signTx,
      @JsonKey(name: 'send_raw_tx') this.sendRawTx,
      @JsonKey(name: 'psbt_sign') this.signPsbt,
      @JsonKey(name: 'psbt_get_details') this.getDetailsPsbt,
  ...
  final List<GdkSubaccount>? _subaccounts;
  @override
  @JsonKey(name: 'subaccounts')
  List<GdkSubaccount>? get subaccounts {
  ...
  @override
  @JsonKey(name: 'change_settings')
  final GdkSettingsEvent? changeSettings;
  @override
  @JsonKey(name: 'blind_transaction')
  final GdkNewTransactionReply? blindTransaction;
  @override
  @JsonKey(name: 'sign_tx')
  ...
  @override
  @JsonKey(name: 'psbt_sign')
  final GdkNewTransactionReply? signPsbt;
  @override
  @JsonKey(name: 'psbt_get_details')
  final GdkNewTransactionReply? getDetailsPsbt;
  @override
  @JsonKey(name: 'unspent_outputs')
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'GdkAuthHandlerStatusResult(loginUser: $loginUser, transactions: $transactions, balance: $balance, getSubaccount: $getSubaccount, subaccounts: $subaccounts, getReceiveAddress: $getReceiveAddress, lastPointer: $lastPointer, list: $list, createTransaction: $createTransaction, changeSettings: $changeSettings, blindTransaction: $blindTransaction, signTx: $signTx, sendRawTx: $sendRawTx, signPsbt: $signPsbt, getDetailsPsbt: $getDetailsPsbt, unspentOutputs: $unspentOutputs)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkAuthHandlerStatusResult'))
      ..add(DiagnosticsProperty('loginUser', loginUser))
      ..add(DiagnosticsProperty('transactions', transactions))
      ..add(DiagnosticsProperty('balance', balance))
      ..add(DiagnosticsProperty('getSubaccount', getSubaccount))
      ..add(DiagnosticsProperty('subaccounts', subaccounts))
      ..add(DiagnosticsProperty('getReceiveAddress', getReceiveAddress))
      ..add(DiagnosticsProperty('lastPointer', lastPointer))
      ..add(DiagnosticsProperty('list', list))
      ..add(DiagnosticsProperty('createTransaction', createTransaction))
      ..add(DiagnosticsProperty('changeSettings', changeSettings))
      ..add(DiagnosticsProperty('blindTransaction', blindTransaction))
      ..add(DiagnosticsProperty('signTx', signTx))
      ..add(DiagnosticsProperty('sendRawTx', sendRawTx))
      ..add(DiagnosticsProperty('signPsbt', signPsbt))
      ..add(DiagnosticsProperty('getDetailsPsbt', getDetailsPsbt))
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.changeSettings, changeSettings) ||
                other.changeSettings == changeSettings) &&
            (identical(other.blindTransaction, blindTransaction) ||
                other.blindTransaction == blindTransaction) &&
            ...
            (identical(other.getDetailsPsbt, getDetailsPsbt) ||
                other.getDetailsPsbt == getDetailsPsbt) &&
...
abstract class _GdkAuthHandlerStatusResult
  ...
  const factory _GdkAuthHandlerStatusResult(
      ...
      @JsonKey(name: 'create_transaction')
      final GdkNewTransactionReply? createTransaction,
      @JsonKey(name: 'change_settings') final GdkSettingsEvent? changeSettings,
      @JsonKey(name: 'blind_transaction')
      final GdkNewTransactionReply? blindTransaction,
      @JsonKey(name: 'sign_tx') final GdkNewTransactionReply? signTx,
      @JsonKey(name: 'send_raw_tx') final GdkNewTransactionReply? sendRawTx,
      @JsonKey(name: 'psbt_sign') final GdkNewTransactionReply? signPsbt,
      @JsonKey(name: 'psbt_get_details')
      final GdkNewTransactionReply? getDetailsPsbt,
      @JsonKey(name: 'unspent_outputs')
  ...
  @override
  @JsonKey(name: 'change_settings')
  GdkSettingsEvent? get changeSettings;
  @override
  @JsonKey(name: 'blind_transaction')
  GdkNewTransactionReply? get blindTransaction;
  @override
  ...
  @override
  @JsonKey(name: 'psbt_sign')
  GdkNewTransactionReply? get signPsbt;
  @override
  @JsonKey(name: 'psbt_get_details')
  GdkNewTransactionReply? get getDetailsPsbt;
  @override
...
class _$GdkAuthHandlerStatusImpl extends _GdkAuthHandlerStatus
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkAuthHandlerStatus'))
      ...
      ..add(DiagnosticsProperty('attemptsRemaining', attemptsRemaining))
      ..add(DiagnosticsProperty('device', device))
      ..add(DiagnosticsProperty('message', message))
      ..add(DiagnosticsProperty('authHandlerId', authHandlerId))
...
class _$GdkGetTransactionsDetailsImpl extends _GdkGetTransactionsDetails
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkGetTransactionsDetails'))
      ..add(DiagnosticsProperty('subaccount', subaccount))
...
/// @nodoc
@JsonSerializable()
class _$GdkTransactionInOutImpl
    with DiagnosticableTreeMixin
    implements _GdkTransactionInOut {
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'GdkTransactionInOut(address: $address, addressType: $addressType, isInternal: $isInternal, isOutput: $isOutput, isRelevant: $isRelevant, isSpent: $isSpent, pointer: $pointer, ptIdx: $ptIdx, satoshi: $satoshi, subaccount: $subaccount, subtype: $subtype, assetId: $assetId, assetBlinder: $assetBlinder, amountBlinder: $amountBlinder)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkTransactionInOut'))
      ...
      ..add(DiagnosticsProperty('isRelevant', isRelevant))
      ..add(DiagnosticsProperty('isSpent', isSpent))
      ..add(DiagnosticsProperty('pointer', pointer))
      ..add(DiagnosticsProperty('ptIdx', ptIdx))
      ..add(DiagnosticsProperty('satoshi', satoshi))
      ..add(DiagnosticsProperty('subaccount', subaccount))
      ..add(DiagnosticsProperty('subtype', subtype))
      ..add(DiagnosticsProperty('assetId', assetId))
      ..add(DiagnosticsProperty('assetBlinder', assetBlinder))
      ..add(DiagnosticsProperty('amountBlinder', amountBlinder));
  }
...
class _$GdkTransactionImpl extends _GdkTransaction
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkTransaction'))
      ..add(DiagnosticsProperty('addressees', addressees))
      ..add(DiagnosticsProperty('blockHeight', blockHeight))
      ..add(DiagnosticsProperty('calculatedFeeRate', calculatedFeeRate))
      ..add(DiagnosticsProperty('canCpfp', canCpfp))
      ..add(DiagnosticsProperty('canRbf', canRbf))
      ..add(DiagnosticsProperty('createdAtTs', createdAtTs))
      ..add(DiagnosticsProperty('fee', fee))
      ..add(DiagnosticsProperty('feeRate', feeRate))
      ..add(DiagnosticsProperty('hasPaymentRequest', hasPaymentRequest))
      ..add(DiagnosticsProperty('inputs', inputs))
      ..add(DiagnosticsProperty('instant', instant))
      ..add(DiagnosticsProperty('memo', memo))
      ..add(DiagnosticsProperty('outputs', outputs))
      ..add(DiagnosticsProperty('rbfOptin', rbfOptin))
      ..add(DiagnosticsProperty('satoshi', satoshi))
      ..add(DiagnosticsProperty('spvVerified', spvVerified))
      ..add(DiagnosticsProperty('transaction', transaction))
      ..add(DiagnosticsProperty('transactionLocktime', transactionLocktime))
      ..add(DiagnosticsProperty('transactionOutputs', transactionOutputs))
      ..add(DiagnosticsProperty('transactionVersion', transactionVersion))
      ..add(DiagnosticsProperty('transactionVsize', transactionVsize))
      ..add(DiagnosticsProperty('transactionWeight', transactionWeight))
      ..add(DiagnosticsProperty('txhash', txhash))
      ..add(DiagnosticsProperty('type', type))
      ..add(DiagnosticsProperty('vsize', vsize))
      ..add(DiagnosticsProperty('swapOutgoingAssetId', swapOutgoingAssetId))
      ..add(DiagnosticsProperty('swapOutgoingSatoshi', swapOutgoingSatoshi))
      ..add(DiagnosticsProperty('swapIncomingAssetId', swapIncomingAssetId))
      ..add(DiagnosticsProperty('swapIncomingSatoshi', swapIncomingSatoshi));
  }
...
/// @nodoc
@JsonSerializable()
class _$GdkEntityImpl with DiagnosticableTreeMixin implements _GdkEntity {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkEntity'))
...
/// @nodoc
@JsonSerializable()
class _$GdkContractImpl with DiagnosticableTreeMixin implements _GdkContract {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkContract'))
      ..add(DiagnosticsProperty('entity', entity))
      ..add(DiagnosticsProperty('issuerPubkey', issuerPubkey))
      ..add(DiagnosticsProperty('name', name))
...
/// @nodoc
@JsonSerializable()
class _$GdkIssuanceImpl with DiagnosticableTreeMixin implements _GdkIssuance {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkIssuance'))
...
/// @nodoc
@JsonSerializable()
class _$GdkAssetInformationImpl
    with DiagnosticableTreeMixin
    implements _GdkAssetInformation {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkAssetInformation'))
      ..add(DiagnosticsProperty('assetId', assetId))
      ..add(DiagnosticsProperty('contract', contract))
      ..add(DiagnosticsProperty('entity', entity))
      ..add(DiagnosticsProperty('issuancePrevout', issuancePrevout))
      ..add(DiagnosticsProperty('issuanceTxin', issuanceTxin))
      ..add(DiagnosticsProperty('issuerPubkey', issuerPubkey))
      ..add(DiagnosticsProperty('name', name))
      ..add(DiagnosticsProperty('precision', precision))
      ..add(DiagnosticsProperty('ticker', ticker))
...
/// @nodoc
@JsonSerializable()
class _$GdkNetworksImpl extends _GdkNetworks with DiagnosticableTreeMixin {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkNetworks'))
      ..add(DiagnosticsProperty('allNetworks', allNetworks))
...
/// @nodoc
@JsonSerializable()
class _$GdkNetworkImpl extends _GdkNetwork with DiagnosticableTreeMixin {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkNetwork'))
      ..add(DiagnosticsProperty('addressExplorerUrl', addressExplorerUrl))
      ..add(DiagnosticsProperty('assetRegistryOnionUrl', assetRegistryOnionUrl))
      ..add(DiagnosticsProperty('assetRegistryUrl', assetRegistryUrl))
      ..add(DiagnosticsProperty('bech32Prefix', bech32Prefix))
      ..add(DiagnosticsProperty('bip21Prefix', bip21Prefix))
      ..add(DiagnosticsProperty('blech32Prefix', blech32Prefix))
      ..add(DiagnosticsProperty('blindedPrefix', blindedPrefix))
      ..add(DiagnosticsProperty('csvBuckets', csvBuckets))
      ..add(DiagnosticsProperty('ctBits', ctBits))
      ..add(DiagnosticsProperty('ctExponent', ctExponent))
      ..add(DiagnosticsProperty('development', development))
      ..add(DiagnosticsProperty('electrumTls', electrumTls))
      ..add(DiagnosticsProperty('electrumUrl', electrumUrl))
      ..add(DiagnosticsProperty('liquid', liquid))
      ..add(DiagnosticsProperty('mainnet', mainnet))
      ..add(DiagnosticsProperty('name', name))
      ..add(DiagnosticsProperty('network', network))
      ..add(DiagnosticsProperty('p2PkhVersion', p2PkhVersion))
      ..add(DiagnosticsProperty('p2ShVersion', p2ShVersion))
      ..add(DiagnosticsProperty('policyAsset', policyAsset))
      ..add(DiagnosticsProperty('serverType', serverType))
      ..add(DiagnosticsProperty('serviceChainCode', serviceChainCode))
      ..add(DiagnosticsProperty('servicePubkey', servicePubkey))
      ..add(DiagnosticsProperty('spvEnabled', spvEnabled))
      ..add(DiagnosticsProperty('spvMulti', spvMulti))
      ..add(DiagnosticsProperty('spvServers', spvServers))
      ..add(DiagnosticsProperty('txExplorerUrl', txExplorerUrl))
      ..add(DiagnosticsProperty('wampCertPins', wampCertPins))
      ..add(DiagnosticsProperty('wampCertRoots', wampCertRoots))
      ..add(DiagnosticsProperty('wampOnionUrl', wampOnionUrl))
      ..add(DiagnosticsProperty('wampUrl', wampUrl));
  }
...
/// @nodoc
@JsonSerializable()
class _$GdkWalletImpl with DiagnosticableTreeMixin implements _GdkWallet {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkWallet'))
      ..add(DiagnosticsProperty('hasTransactions', hasTransactions))
      ..add(DiagnosticsProperty('hidden', hidden))
      ..add(DiagnosticsProperty('name', name))
      ..add(DiagnosticsProperty('pointer', pointer))
      ..add(DiagnosticsProperty('receivingId', receivingId))
...
class _$GdkReceiveAddressDetailsImpl extends _GdkReceiveAddressDetails
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'GdkReceiveAddressDetails(address: $address, addressType: $addressType, branch: $branch, pointer: $pointer, script: $script, subaccount: $subaccount, subtype: $subtype, userPath: $userPath)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkReceiveAddressDetails'))
      ..add(DiagnosticsProperty('address', address))
      ..add(DiagnosticsProperty('addressType', addressType))
...
class _$GdkPreviousAddressesDetailsImpl extends _GdkPreviousAddressesDetails
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkPreviousAddressesDetails'))
      ..add(DiagnosticsProperty('subaccount', subaccount))
      ..add(DiagnosticsProperty('lastPointer', lastPointer))
      ..add(DiagnosticsProperty('isInternal', isInternal));
  }
...
mixin _$GdkPreviousAddress {
  ...
  @JsonKey(name: 'unconfidential_address')
...
class _$GdkPreviousAddressImpl extends _GdkPreviousAddress
  ...
  const _$GdkPreviousAddressImpl(
      ...
      @JsonKey(name: 'scriptpubkey') this.scriptPubkey,
      @JsonKey(name: 'user_path') final List<int>? userPath,
      @JsonKey(name: 'tx_count') this.txCount,
      @JsonKey(name: 'is_blinded') this.isBlinded,
      @JsonKey(name: 'unconfidential_address') this.unblindedAddress,
...
// For liquid only
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'GdkPreviousAddress(address: $address, addressType: $addressType, subaccount: $subaccount, isInternal: $isInternal, pointer: $pointer, scriptPubkey: $scriptPubkey, userPath: $userPath, txCount: $txCount, isBlinded: $isBlinded, unblindedAddress: $unblindedAddress, blindingKey: $blindingKey)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkPreviousAddress'))
      ..add(DiagnosticsProperty('address', address))
      ..add(DiagnosticsProperty('addressType', addressType))
      ..add(DiagnosticsProperty('subaccount', subaccount))
      ..add(DiagnosticsProperty('isInternal', isInternal))
      ..add(DiagnosticsProperty('pointer', pointer))
      ..add(DiagnosticsProperty('scriptPubkey', scriptPubkey))
      ..add(DiagnosticsProperty('userPath', userPath))
      ..add(DiagnosticsProperty('txCount', txCount))
      ..add(DiagnosticsProperty('isBlinded', isBlinded))
      ..add(DiagnosticsProperty('unblindedAddress', unblindedAddress))
...
abstract class _GdkPreviousAddress extends GdkPreviousAddress {
  const factory _GdkPreviousAddress(
      ...
      @JsonKey(name: 'scriptpubkey') final String? scriptPubkey,
      @JsonKey(name: 'user_path') final List<int>? userPath,
      @JsonKey(name: 'tx_count') final int? txCount,
      @JsonKey(name: 'is_blinded') final bool? isBlinded,
      @JsonKey(name: 'unconfidential_address') final String? unblindedAddress,
      @JsonKey(name: 'blinding_key')
      final String? blindingKey}) = _$GdkPreviousAddressImpl;
...
/// @nodoc
@JsonSerializable()
class _$GdkCreatePsetInputsImpl
    with DiagnosticableTreeMixin
    implements _GdkCreatePsetInputs {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkCreatePsetInputs'))
      ..add(DiagnosticsProperty('asset', asset))
      ..add(DiagnosticsProperty('assetBf', assetBf))
      ..add(DiagnosticsProperty('txid', txid))
      ..add(DiagnosticsProperty('value', value))
      ..add(DiagnosticsProperty('valueBf', valueBf))
      ..add(DiagnosticsProperty('vout', vout));
  }
...
class _$GdkSignPsbtDetailsImpl extends _GdkSignPsbtDetails
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkSignPsbtDetails'))
      ..add(DiagnosticsProperty('psbt', psbt))
      ..add(DiagnosticsProperty('utxos', utxos))
      ..add(DiagnosticsProperty('blindingNonces', blindingNonces));
  }
...
class _$GdkSignPsbtResultImpl extends _GdkSignPsbtResult
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkSignPsbtResult'))
      ..add(DiagnosticsProperty('psbt', psbt))
      ..add(DiagnosticsProperty('utxos', utxos));
  }
...
GdkPsbtGetDetails _$GdkPsbtGetDetailsFromJson(Map<String, dynamic> json) {
  return _GdkPsbtGetDetails.fromJson(json);
}

/// @nodoc
mixin _$GdkPsbtGetDetails {
  @JsonKey(name: 'psbt')
  String get psbt => throw _privateConstructorUsedError;
  @JsonKey(name: 'utxos')
  List<Map<String, dynamic>> get utxos => throw _privateConstructorUsedError;
  ...
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $GdkPsbtGetDetailsCopyWith<GdkPsbtGetDetails> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GdkPsbtGetDetailsCopyWith<$Res> {
  factory $GdkPsbtGetDetailsCopyWith(
          GdkPsbtGetDetails value, $Res Function(GdkPsbtGetDetails) then) =
      _$GdkPsbtGetDetailsCopyWithImpl<$Res, GdkPsbtGetDetails>;
  @useResult
  $Res call(
      {@JsonKey(name: 'psbt') String psbt,
      @JsonKey(name: 'utxos') List<Map<String, dynamic>> utxos});
...
/// @nodoc
class _$GdkPsbtGetDetailsCopyWithImpl<$Res, $Val extends GdkPsbtGetDetails>
    implements $GdkPsbtGetDetailsCopyWith<$Res> {
  _$GdkPsbtGetDetailsCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$GdkPsbtGetDetailsImplCopyWith<$Res>
    implements $GdkPsbtGetDetailsCopyWith<$Res> {
  factory _$$GdkPsbtGetDetailsImplCopyWith(_$GdkPsbtGetDetailsImpl value,
          $Res Function(_$GdkPsbtGetDetailsImpl) then) =
      __$$GdkPsbtGetDetailsImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'psbt') String psbt,
...
/// @nodoc
class __$$GdkPsbtGetDetailsImplCopyWithImpl<$Res>
    extends _$GdkPsbtGetDetailsCopyWithImpl<$Res, _$GdkPsbtGetDetailsImpl>
    implements _$$GdkPsbtGetDetailsImplCopyWith<$Res> {
  __$$GdkPsbtGetDetailsImplCopyWithImpl(_$GdkPsbtGetDetailsImpl _value,
      $Res Function(_$GdkPsbtGetDetailsImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GdkPsbtGetDetailsImpl(
      psbt: null == psbt
          ? _value.psbt
          : psbt // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$GdkPsbtGetDetailsImpl extends _GdkPsbtGetDetails
    with DiagnosticableTreeMixin {
  const _$GdkPsbtGetDetailsImpl(
      {@JsonKey(name: 'psbt') required this.psbt,
      @JsonKey(name: 'utxos') required final List<Map<String, dynamic>> utxos})
      : _utxos = utxos,
        super._();

  factory _$GdkPsbtGetDetailsImpl.fromJson(Map<String, dynamic> json) =>
      _$$GdkPsbtGetDetailsImplFromJson(json);
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'GdkPsbtGetDetails(psbt: $psbt, utxos: $utxos)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkPsbtGetDetails'))
      ..add(DiagnosticsProperty('psbt', psbt))
      ..add(DiagnosticsProperty('utxos', utxos));
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GdkPsbtGetDetailsImpl &&
            (identical(other.psbt, psbt) || other.psbt == psbt) &&
            const DeepCollectionEquality().equals(other._utxos, _utxos));
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GdkPsbtGetDetailsImplCopyWith<_$GdkPsbtGetDetailsImpl> get copyWith =>
      __$$GdkPsbtGetDetailsImplCopyWithImpl<_$GdkPsbtGetDetailsImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GdkPsbtGetDetailsImplToJson(
      this,
    );
  }
}

abstract class _GdkPsbtGetDetails extends GdkPsbtGetDetails {
  const factory _GdkPsbtGetDetails(
          {@JsonKey(name: 'psbt') required final String psbt,
          @JsonKey(name: 'utxos')
          required final List<Map<String, dynamic>> utxos}) =
      _$GdkPsbtGetDetailsImpl;
  const _GdkPsbtGetDetails._() : super._();

  factory _GdkPsbtGetDetails.fromJson(Map<String, dynamic> json) =
      _$GdkPsbtGetDetailsImpl.fromJson;
...
GdkPsbtGetDetailsResult _$GdkPsbtGetDetailsResultFromJson(
    Map<String, dynamic> json) {
  return _GdkPsbtGetDetailsResult.fromJson(json);
}

/// @nodoc
mixin _$GdkPsbtGetDetailsResult {
  @JsonKey(name: 'inputs')
  List<GdkUnspentOutputs> get inputs => throw _privateConstructorUsedError;
  @JsonKey(name: 'outputs')
  List<GdkUnspentOutputs> get outputs => throw _privateConstructorUsedError;

  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $GdkPsbtGetDetailsResultCopyWith<GdkPsbtGetDetailsResult> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GdkPsbtGetDetailsResultCopyWith<$Res> {
  factory $GdkPsbtGetDetailsResultCopyWith(GdkPsbtGetDetailsResult value,
          $Res Function(GdkPsbtGetDetailsResult) then) =
      _$GdkPsbtGetDetailsResultCopyWithImpl<$Res, GdkPsbtGetDetailsResult>;
  @useResult
  $Res call(
      {@JsonKey(name: 'inputs') List<GdkUnspentOutputs> inputs,
      @JsonKey(name: 'outputs') List<GdkUnspentOutputs> outputs});
}

/// @nodoc
class _$GdkPsbtGetDetailsResultCopyWithImpl<$Res,
        $Val extends GdkPsbtGetDetailsResult>
    implements $GdkPsbtGetDetailsResultCopyWith<$Res> {
  _$GdkPsbtGetDetailsResultCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$GdkPsbtGetDetailsResultImplCopyWith<$Res>
    implements $GdkPsbtGetDetailsResultCopyWith<$Res> {
  factory _$$GdkPsbtGetDetailsResultImplCopyWith(
          _$GdkPsbtGetDetailsResultImpl value,
          $Res Function(_$GdkPsbtGetDetailsResultImpl) then) =
      __$$GdkPsbtGetDetailsResultImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'inputs') List<GdkUnspentOutputs> inputs,
...
/// @nodoc
class __$$GdkPsbtGetDetailsResultImplCopyWithImpl<$Res>
    extends _$GdkPsbtGetDetailsResultCopyWithImpl<$Res,
        _$GdkPsbtGetDetailsResultImpl>
    implements _$$GdkPsbtGetDetailsResultImplCopyWith<$Res> {
  __$$GdkPsbtGetDetailsResultImplCopyWithImpl(
      _$GdkPsbtGetDetailsResultImpl _value,
      $Res Function(_$GdkPsbtGetDetailsResultImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GdkPsbtGetDetailsResultImpl(
      inputs: null == inputs
          ? _value._inputs
          : inputs // ignore: cast_nullable_to_non_nullable
              as List<GdkUnspentOutputs>,
...
/// @nodoc
@JsonSerializable()
class _$GdkPsbtGetDetailsResultImpl extends _GdkPsbtGetDetailsResult
    with DiagnosticableTreeMixin {
  const _$GdkPsbtGetDetailsResultImpl(
      {@JsonKey(name: 'inputs') required final List<GdkUnspentOutputs> inputs,
      @JsonKey(name: 'outputs') required final List<GdkUnspentOutputs> outputs})
      : _inputs = inputs,
        _outputs = outputs,
        super._();

  factory _$GdkPsbtGetDetailsResultImpl.fromJson(Map<String, dynamic> json) =>
      _$$GdkPsbtGetDetailsResultImplFromJson(json);

  final List<GdkUnspentOutputs> _inputs;
  @override
  @JsonKey(name: 'inputs')
  List<GdkUnspentOutputs> get inputs {
    if (_inputs is EqualUnmodifiableListView) return _inputs;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_inputs);
  }

  final List<GdkUnspentOutputs> _outputs;
  @override
  @JsonKey(name: 'outputs')
  List<GdkUnspentOutputs> get outputs {
    if (_outputs is EqualUnmodifiableListView) return _outputs;
    // ignore: implicit_dynamic_type
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'GdkPsbtGetDetailsResult(inputs: $inputs, outputs: $outputs)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkPsbtGetDetailsResult'))
      ..add(DiagnosticsProperty('inputs', inputs))
      ..add(DiagnosticsProperty('outputs', outputs));
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GdkPsbtGetDetailsResultImpl &&
            const DeepCollectionEquality().equals(other._inputs, _inputs) &&
            const DeepCollectionEquality().equals(other._outputs, _outputs));
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GdkPsbtGetDetailsResultImplCopyWith<_$GdkPsbtGetDetailsResultImpl>
      get copyWith => __$$GdkPsbtGetDetailsResultImplCopyWithImpl<
          _$GdkPsbtGetDetailsResultImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GdkPsbtGetDetailsResultImplToJson(
      this,
    );
  }
}

abstract class _GdkPsbtGetDetailsResult extends GdkPsbtGetDetailsResult {
  const factory _GdkPsbtGetDetailsResult(
      {@JsonKey(name: 'inputs') required final List<GdkUnspentOutputs> inputs,
      @JsonKey(name: 'outputs')
      required final List<GdkUnspentOutputs>
          outputs}) = _$GdkPsbtGetDetailsResultImpl;
  const _GdkPsbtGetDetailsResult._() : super._();

  factory _GdkPsbtGetDetailsResult.fromJson(Map<String, dynamic> json) =
      _$GdkPsbtGetDetailsResultImpl.fromJson;
...
/// @nodoc
@JsonSerializable()
class _$GdkGetFeeEstimatesEventImpl
    with DiagnosticableTreeMixin
    implements _GdkGetFeeEstimatesEvent {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkGetFeeEstimatesEvent'))
...
/// @nodoc
@JsonSerializable()
class _$GdkBlockEventImpl
    with DiagnosticableTreeMixin
    implements _GdkBlockEvent {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkBlockEvent'))
      ..add(DiagnosticsProperty('blockHash', blockHash))
      ..add(DiagnosticsProperty('blockHeight', blockHeight))
      ..add(DiagnosticsProperty('initialTimestamp', initialTimestamp))
      ..add(DiagnosticsProperty('previousHash', previousHash));
  }
...
class _$GdkSettingsEventNotificationsImpl
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkSettingsEventNotifications'))
      ..add(DiagnosticsProperty('emailIncoming', emailIncoming))
      ..add(DiagnosticsProperty('emailOutgoing', emailOutgoing));
  }
...
/// @nodoc
@JsonSerializable()
class _$GdkSettingsEventImpl extends _GdkSettingsEvent
    with DiagnosticableTreeMixin {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkSettingsEvent'))
      ..add(DiagnosticsProperty('altimeout', altimeout))
      ..add(DiagnosticsProperty('csvtime', csvtime))
      ..add(DiagnosticsProperty('nlocktime', nlocktime))
      ..add(DiagnosticsProperty('notifications', notifications))
      ..add(DiagnosticsProperty('pgp', pgp))
      ..add(DiagnosticsProperty('pricing', pricing))
      ..add(DiagnosticsProperty('requiredNumBlocks', requiredNumBlocks))
...
abstract class _GdkSettingsEvent extends GdkSettingsEvent {
  ...
  const _GdkSettingsEvent._() : super._();
...
/// @nodoc
@JsonSerializable()
class _$GdkTransactionEventImpl
    with DiagnosticableTreeMixin
    implements _GdkTransactionEvent {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkTransactionEvent'))
      ..add(DiagnosticsProperty('satoshi', satoshi))
      ..add(DiagnosticsProperty('subaccounts', subaccounts))
      ..add(DiagnosticsProperty('txhash', txhash))
      ..add(DiagnosticsProperty('type', type));
...
/// @nodoc
@JsonSerializable()
class _$GdkPricingImpl with DiagnosticableTreeMixin implements _GdkPricing {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkPricing'))
...
mixin _$GdkAddressee {
  ...
  @JsonKey(name: 'asset_id')
  String? get assetId => throw _privateConstructorUsedError;
  @JsonKey(name: 'is_greedy')
  bool? get isGreedy => throw _privateConstructorUsedError;
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      assetId: freezed == assetId
          ...
          : assetId // ignore: cast_nullable_to_non_nullable
              as String?,
      isGreedy: freezed == isGreedy
          ? _value.isGreedy
          : isGreedy // ignore: cast_nullable_to_non_nullable
              as bool?,
    ) as $Val);
  }
}
...
/// @nodoc
@JsonSerializable()
class _$GdkAddresseeImpl with DiagnosticableTreeMixin implements _GdkAddressee {
  const _$GdkAddresseeImpl(
      {this.address,
      this.satoshi,
      @JsonKey(name: 'asset_id') this.assetId,
      @JsonKey(name: 'is_greedy') this.isGreedy});
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'GdkAddressee(address: $address, satoshi: $satoshi, assetId: $assetId, isGreedy: $isGreedy)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkAddressee'))
      ..add(DiagnosticsProperty('address', address))
      ..add(DiagnosticsProperty('satoshi', satoshi))
      ..add(DiagnosticsProperty('assetId', assetId))
      ..add(DiagnosticsProperty('isGreedy', isGreedy));
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.satoshi, satoshi) || other.satoshi == satoshi) &&
            (identical(other.assetId, assetId) || other.assetId == assetId) &&
            (identical(other.isGreedy, isGreedy) ||
                other.isGreedy == isGreedy));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode =>
      Object.hash(runtimeType, address, satoshi, assetId, isGreedy);
...
abstract class _GdkAddressee implements GdkAddressee {
  const factory _GdkAddressee(
      ...
      final int? satoshi,
      @JsonKey(name: 'asset_id') final String? assetId,
      @JsonKey(name: 'is_greedy') final bool? isGreedy}) = _$GdkAddresseeImpl;
...
mixin _$GdkNewTransaction {
  ...
  Map<String, dynamic>? get transactionInputs =>
      throw _privateConstructorUsedError;
  String? get memo => throw _privateConstructorUsedError;
  Map<String, List<GdkUnspentOutputs>>? get utxos =>
      throw _privateConstructorUsedError;
  @JsonKey(name: 'previous_transaction')
  GdkTransaction? get previousTransaction => throw _privateConstructorUsedError;
...
abstract class $GdkNewTransactionCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'previous_transaction')
      GdkTransaction? previousTransaction});

  $GdkTransactionCopyWith<$Res>? get previousTransaction;
}
...
class _$GdkNewTransactionCopyWithImpl<$Res, $Val extends GdkNewTransaction>
  ...
  $Res call({
    ...
    Object? transactionInputs = freezed,
    Object? memo = freezed,
    Object? utxos = freezed,
    Object? previousTransaction = freezed,
  }) {
    return _then(_value.copyWith(
      addressees: freezed == addressees
          ? _value.addressees
      ...
      transactionInputs: freezed == transactionInputs
          ? _value.transactionInputs
          : transactionInputs // ignore: cast_nullable_to_non_nullable
              as Map<String, dynamic>?,
      memo: freezed == memo
          ? _value.memo
          : memo // ignore: cast_nullable_to_non_nullable
      ...
      previousTransaction: freezed == previousTransaction
  ...
  @pragma('vm:prefer-inline')
  $GdkTransactionCopyWith<$Res>? get previousTransaction {
    if (_value.previousTransaction == null) {
      return null;
    }

    return $GdkTransactionCopyWith<$Res>(_value.previousTransaction!, (value) {
      return _then(_value.copyWith(previousTransaction: value) as $Val);
    });
  }
}
...
class _$GdkNewTransactionImpl extends _GdkNewTransaction
  ...
  const _$GdkNewTransactionImpl(
      ...
      @JsonKey(name: 'transaction_inputs')
      final Map<String, dynamic>? transactionInputs,
      this.memo,
      final Map<String, List<GdkUnspentOutputs>>? utxos,
      @JsonKey(name: 'previous_transaction') this.previousTransaction})
      : _addressees = addressees,
  ...
  final Map<String, dynamic>? _transactionInputs;
  @override
  @JsonKey(name: 'transaction_inputs')
  Map<String, dynamic>? get transactionInputs {
    final value = _transactionInputs;
    if (value == null) return null;
    if (_transactionInputs is EqualUnmodifiableMapView)
  ...
  @override
  @JsonKey(name: 'previous_transaction')
  final GdkTransaction? previousTransaction;

  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'GdkNewTransaction(addressees: $addressees, subaccount: $subaccount, feeRate: $feeRate, utxoStrategy: $utxoStrategy, transactionInputs: $transactionInputs, memo: $memo, utxos: $utxos, previousTransaction: $previousTransaction)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkNewTransaction'))
      ..add(DiagnosticsProperty('addressees', addressees))
      ..add(DiagnosticsProperty('subaccount', subaccount))
      ..add(DiagnosticsProperty('feeRate', feeRate))
      ..add(DiagnosticsProperty('utxoStrategy', utxoStrategy))
      ..add(DiagnosticsProperty('transactionInputs', transactionInputs))
      ..add(DiagnosticsProperty('memo', memo))
      ..add(DiagnosticsProperty('utxos', utxos))
      ..add(DiagnosticsProperty('previousTransaction', previousTransaction));
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._transactionInputs, _transactionInputs) &&
            (identical(other.memo, memo) || other.memo == memo) &&
            const DeepCollectionEquality().equals(other._utxos, _utxos) &&
  ...
  int get hashCode => Object.hash(
      ...
      feeRate,
      utxoStrategy,
      const DeepCollectionEquality().hash(_transactionInputs),
      memo,
      const DeepCollectionEquality().hash(_utxos),
      previousTransaction);
...
abstract class _GdkNewTransaction extends GdkNewTransaction {
  const factory _GdkNewTransaction(
      ...
      final Map<String, List<GdkUnspentOutputs>>? utxos,
      @JsonKey(name: 'previous_transaction')
      final GdkTransaction? previousTransaction}) = _$GdkNewTransactionImpl;
  ...
  @override
  @JsonKey(name: 'previous_transaction')
  GdkTransaction? get previousTransaction;
  @override
  @JsonKey(ignore: true)
  _$$GdkNewTransactionImplCopyWith<_$GdkNewTransactionImpl> get copyWith =>
      throw _privateConstructorUsedError;
...
mixin _$GdkNewTransactionReply {
  ...
  @JsonKey(name: 'transaction_inputs')
  List<GdkUnspentOutputs>? get transactionInputs =>
      throw _privateConstructorUsedError;
  String? get txhash => throw _privateConstructorUsedError;
  GdkTransactionTypeEnum? get type => throw _privateConstructorUsedError;
  @JsonKey(name: 'utxo_strategy')
...
class _$GdkNewTransactionReplyImpl extends _GdkNewTransactionReply
  ...
  const _$GdkNewTransactionReplyImpl(
      ...
      @JsonKey(name: 'spv_verified') this.spvVerified,
      @JsonKey(name: 'is_blinded') this.isBlinded,
      @JsonKey(name: 'is_partial') this.isPartial,
      this.subaccount = 1,
      this.timestamp,
      this.transaction,
      this.psbt,
      ...
      @JsonKey(name: 'transaction_inputs')
      final List<GdkUnspentOutputs>? transactionInputs,
      this.txhash,
      this.type,
  ...
  final List<GdkUnspentOutputs>? _transactionInputs;
  @override
  @JsonKey(name: 'transaction_inputs')
  List<GdkUnspentOutputs>? get transactionInputs {
    final value = _transactionInputs;
    if (value == null) return null;
    if (_transactionInputs is EqualUnmodifiableListView)
      return _transactionInputs;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(value);
  }
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'GdkNewTransactionReply(addressees: $addressees, createdAt: $createdAt, error: $error, fee: $fee, feeRate: $feeRate, calculatedFeeRate: $calculatedFeeRate, networkFee: $networkFee, isSweep: $isSweep, network: $network, rbfOptin: $rbfOptin, satoshi: $satoshi, spvVerified: $spvVerified, isBlinded: $isBlinded, isPartial: $isPartial, subaccount: $subaccount, timestamp: $timestamp, transaction: $transaction, psbt: $psbt, transactionVsize: $transactionVsize, transactionWeight: $transactionWeight, transactionVersion: $transactionVersion, transactionLocktime: $transactionLocktime, transactionOutputs: $transactionOutputs, transactionInputs: $transactionInputs, txhash: $txhash, type: $type, utxoStrategy: $utxoStrategy, memo: $memo, utxos: $utxos)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkNewTransactionReply'))
      ..add(DiagnosticsProperty('addressees', addressees))
      ...
      ..add(DiagnosticsProperty('feeRate', feeRate))
      ..add(DiagnosticsProperty('calculatedFeeRate', calculatedFeeRate))
      ..add(DiagnosticsProperty('networkFee', networkFee))
      ..add(DiagnosticsProperty('isSweep', isSweep))
      ..add(DiagnosticsProperty('network', network))
      ..add(DiagnosticsProperty('rbfOptin', rbfOptin))
      ..add(DiagnosticsProperty('satoshi', satoshi))
      ..add(DiagnosticsProperty('spvVerified', spvVerified))
...
abstract class _GdkNewTransactionReply extends GdkNewTransactionReply {
  const factory _GdkNewTransactionReply(
      ...
      final Map<String, List<GdkUnspentOutputs>>?
          utxos}) = _$GdkNewTransactionReplyImpl;
...
/// @nodoc
@JsonSerializable()
class _$GdkRegisterNetworkDataImpl
    with DiagnosticableTreeMixin
    implements _GdkRegisterNetworkData {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkRegisterNetworkData'))
      ..add(DiagnosticsProperty('name', name))
      ..add(DiagnosticsProperty('networkDetails', networkDetails));
  }
...
/// @nodoc
@JsonSerializable()
class _$GdkSessionEventImpl
    with DiagnosticableTreeMixin
    implements _GdkSessionEvent {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkSessionEvent'))
...
/// @nodoc
@JsonSerializable()
class _$GdkNetworkEventImpl
    with DiagnosticableTreeMixin
    implements _GdkNetworkEvent {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkNetworkEvent'))
      ..add(DiagnosticsProperty('waitMs', waitMs))
      ..add(DiagnosticsProperty('currentState', currentState))
      ..add(DiagnosticsProperty('nextState', nextState));
  }
...
class _$GdkConvertDataImpl extends _GdkConvertData
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkConvertData'))
      ..add(DiagnosticsProperty('satoshi', satoshi))
      ..add(DiagnosticsProperty('bits', bits))
      ..add(DiagnosticsProperty('fiatCurrency', fiatCurrency))
      ..add(DiagnosticsProperty('fiatRate', fiatRate));
  }
...
/// @nodoc
@JsonSerializable()
class _$GdkAmountDataImpl
    with DiagnosticableTreeMixin
    implements _GdkAmountData {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkAmountData'))
      ..add(DiagnosticsProperty('bits', bits))
      ..add(DiagnosticsProperty('btc', btc))
      ..add(DiagnosticsProperty('fiat', fiat))
      ..add(DiagnosticsProperty('fiatCurrency', fiatCurrency))
      ..add(DiagnosticsProperty('fiatRate', fiatRate))
      ..add(DiagnosticsProperty('mbtc', mbtc))
      ..add(DiagnosticsProperty('satoshi', satoshi))
      ..add(DiagnosticsProperty('sats', sats))
      ..add(DiagnosticsProperty('subaccount', subaccount))
      ..add(DiagnosticsProperty('ubtc', ubtc))
...
mixin _$GdkGetUnspentOutputs {
  ...
  GdkUnspentOutputSortEnum? get sortBy => throw _privateConstructorUsedError;
...
class _$GdkGetUnspentOutputsImpl extends _GdkGetUnspentOutputs
  ...
  @override
  @JsonKey(name: 'sort_by')
  final GdkUnspentOutputSortEnum? sortBy;

  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'GdkGetUnspentOutputs(subaccount: $subaccount, numConfs: $numConfs, allCoins: $allCoins, expiredAt: $expiredAt, confidential: $confidential, dustLimit: $dustLimit, sortBy: $sortBy)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkGetUnspentOutputs'))
      ..add(DiagnosticsProperty('subaccount', subaccount))
      ..add(DiagnosticsProperty('numConfs', numConfs))
      ..add(DiagnosticsProperty('allCoins', allCoins))
      ..add(DiagnosticsProperty('expiredAt', expiredAt))
  ...
  @override
  int get hashCode => Object.hash(runtimeType, subaccount, numConfs, allCoins,
      expiredAt, confidential, dustLimit, sortBy);
...
abstract class _GdkGetUnspentOutputs extends GdkGetUnspentOutputs {
  const factory _GdkGetUnspentOutputs(
          ...
          @JsonKey(name: 'sort_by') final GdkUnspentOutputSortEnum? sortBy}) =
  ...
  @override
  @JsonKey(name: 'sort_by')
  GdkUnspentOutputSortEnum? get sortBy;
  @override
  @JsonKey(ignore: true)
  _$$GdkGetUnspentOutputsImplCopyWith<_$GdkGetUnspentOutputsImpl>
      get copyWith => throw _privateConstructorUsedError;
...
/// @nodoc
@JsonSerializable()
class _$GdkUnspentOutputsReplyImpl
    with DiagnosticableTreeMixin
    implements _GdkUnspentOutputsReply {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkUnspentOutputsReply'))
      ..add(DiagnosticsProperty('unsentOutputs', unsentOutputs));
  }
...
mixin _$GdkUnspentOutputs {
  ...
  int? get subtype => throw _privateConstructorUsedError;
  int? get sequence => throw _privateConstructorUsedError; // Liquid specific
  @JsonKey(name: 'is_blinded')
...
/// @nodoc
@JsonSerializable()
class _$GdkUnspentOutputsImpl
    with DiagnosticableTreeMixin
    implements _GdkUnspentOutputs {
  const _$GdkUnspentOutputsImpl(
      ...
      this.subtype,
      this.sequence,
      @JsonKey(name: 'is_blinded') this.blinded,
      @JsonKey(name: 'is_confidential') this.confidential,
      @JsonKey(name: 'asset_id') this.assetId,
      @JsonKey(name: 'assetblinder') this.assetBlinder,
      @JsonKey(name: 'amountblinder') this.amountBlinder,
      ...
      @JsonKey(name: 'unconfidential_address') this.unconfidentialAddress})
      : _userPath = userPath;
...
// Liquid specific
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'GdkUnspentOutputs(addressType: $addressType, blockHeight: $blockHeight, isInternal: $isInternal, isRelevant: $isRelevant, isSpent: $isSpent, pointer: $pointer, ptIdx: $ptIdx, satoshi: $satoshi, subaccount: $subaccount, txhash: $txhash, script: $script, prevoutScript: $prevoutScript, userPath: $userPath, publicKey: $publicKey, expiryHeight: $expiryHeight, userStatus: $userStatus, subtype: $subtype, sequence: $sequence, blinded: $blinded, confidential: $confidential, assetId: $assetId, assetBlinder: $assetBlinder, amountBlinder: $amountBlinder, assetTag: $assetTag, commitment: $commitment, nonceCommitment: $nonceCommitment, unconfidentialAddress: $unconfidentialAddress)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkUnspentOutputs'))
      ..add(DiagnosticsProperty('addressType', addressType))
      ..add(DiagnosticsProperty('blockHeight', blockHeight))
      ..add(DiagnosticsProperty('isInternal', isInternal))
      ..add(DiagnosticsProperty('isRelevant', isRelevant))
      ...
      ..add(DiagnosticsProperty('txhash', txhash))
      ..add(DiagnosticsProperty('script', script))
      ..add(DiagnosticsProperty('prevoutScript', prevoutScript))
      ..add(DiagnosticsProperty('userPath', userPath))
      ..add(DiagnosticsProperty('publicKey', publicKey))
      ..add(DiagnosticsProperty('expiryHeight', expiryHeight))
      ..add(DiagnosticsProperty('userStatus', userStatus))
      ..add(DiagnosticsProperty('subtype', subtype))
      ..add(DiagnosticsProperty('sequence', sequence))
      ..add(DiagnosticsProperty('blinded', blinded))
      ..add(DiagnosticsProperty('confidential', confidential))
      ..add(DiagnosticsProperty('assetId', assetId))
      ..add(DiagnosticsProperty('assetBlinder', assetBlinder))
      ..add(DiagnosticsProperty('amountBlinder', amountBlinder))
      ..add(DiagnosticsProperty('assetTag', assetTag))
      ..add(DiagnosticsProperty('commitment', commitment))
      ..add(DiagnosticsProperty('nonceCommitment', nonceCommitment))
      ..add(
          DiagnosticsProperty('unconfidentialAddress', unconfidentialAddress));
  }
...
abstract class _GdkUnspentOutputs implements GdkUnspentOutputs {
  const factory _GdkUnspentOutputs(
      ...
      final int? subtype,
      final int? sequence,
      @JsonKey(name: 'is_blinded') final bool? blinded,
      @JsonKey(name: 'is_confidential') final bool? confidential,
      @JsonKey(name: 'asset_id') final String? assetId,
      @JsonKey(name: 'assetblinder') final String? assetBlinder,
      @JsonKey(name: 'amountblinder') final String? amountBlinder,
      ...
      @JsonKey(name: 'unconfidential_address')
      final String? unconfidentialAddress}) = _$GdkUnspentOutputsImpl;
...
/// @nodoc
@JsonSerializable()
class _$GdkCurrencyDataImpl
    with DiagnosticableTreeMixin
    implements _GdkCurrencyData {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'GdkCurrencyData'))
      ..add(DiagnosticsProperty('all', all))
      ..add(DiagnosticsProperty('perExchange', perExchange));
  }
