...
enum OnRampIntegrationType { beaverBitcoin, pocketBitcoin, meld, elektra, guardarian}
...
class OnRampIntegration with _$OnRampIntegration {
  ...
  static List<OnRampIntegration> get allIntegrations => [
        ...
        OnRampIntegration.guardarian(),
      ];

  // Static instances

  factory OnRampIntegration.guardarian() => OnRampIntegration(
        name: 'Guardarian',
        logoLight: SvgsMarketplace.guardarianBlack,
        logoDark: SvgsMarketplace.guardarianBlack,
        type: OnRampIntegrationType.guardarian,
        paymentOptions: [
        ...
        allRegions: true,
        openInBrowser: false,
        refLinkMainnet: 'https://api-payments.guardarian.com/v1/transaction',
        refLinkTestnet: null,
        priceApi: 'https://api-payments.guardarian.com/v1/estimate',
