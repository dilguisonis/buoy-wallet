...
void _transactionDbModelSerialize(
  ...
  writer.writeString(offsets[1], object.receiveAddress);
  writer.writeString(offsets[2], object.serviceAddress);
  writer.writeString(offsets[3], object.serviceOrderId);
...
TransactionDbModel _transactionDbModelDeserialize(
  ...
  final object = TransactionDbModel(
    ...
    id: id,
    receiveAddress: reader.readStringOrNull(offsets[1]),
    serviceAddress: reader.readStringOrNull(offsets[2]),
    serviceOrderId: reader.readStringOrNull(offsets[3]),
    txhash: reader.readString(offsets[4]),
