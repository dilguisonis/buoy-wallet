...
class _$TransactionDbModelImpl extends _TransactionDbModel {
  ...
  @override
  String toString() {
    return 'TransactionDbModel(id: $id, txhash: $txhash, receiveAddress: $receiveAddress, assetId: $assetId, type: $type, serviceOrderId: $serviceOrderId, serviceAddress: $serviceAddress)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, txhash, receiveAddress,
      assetId, type, serviceOrderId, serviceAddress);
...
abstract class _TransactionDbModel extends TransactionDbModel {
  const factory _TransactionDbModel(
      ...
      final String? serviceOrderId,
      final String? serviceAddress}) = _$TransactionDbModelImpl;
